SUBROUTINE rad_int(                   &
  ...
  USE mo_cloud     ,ONLY: ceffmin,      & ! minimum effective radius
                          ...
                          ceffmax,      & ! maximum effective radius
                                          ! of ice clouds
                          ccwmin
  USE mo_control   ,ONLY: lsocol          ! switch of SOCOL           !MSSOCOL
  USE mo_socol_strataerosols, ONLY: tau_strataer_lw ! Optical depth   !MSSOCOL 
                                          ! of stratospheric aerosols !MSSOCOL
...
!
  ...
  ! =================
     ...
     CASE (1,2,3,4,10)                                                !MSSOCOL
     !CASE (1,2,3,4)                                                  !MSSOCOL
       DO jk = 1, klev
         ...
         DO jaer = kaer+1, kaer+knewaer
           ...
           DO jl = 1, kproma
             IF (iaero .EQ. 10 .AND. (jaer-kaer .EQ. 3 .OR. jaer-kaer .EQ. 4 &
                  .OR. jaer-kaer .EQ. 7 .OR. jaer-kaer .EQ. 9)) THEN  !MSSOCOL
             ...
             ENDIF                                                    !MSSOCOL
             ! optical thickness of newaer GADS aerosols in 5 JJM bands
     ...
     IF (lsocol) THEN                                                 !MSSOCOL
        DO jk = 1, klev                                               !MSSOCOL
           ztauaerl(1:kproma,jk,:) = ztauaerl(1:kproma,jk,:) + &      !MSSOCOL
                tau_strataer_lw(1:kproma,klev+1-jk,:)                 !MSSOCOL
        ENDDO                                                         !MSSOCOL
     ENDIF                                                            !MSSOCOL
