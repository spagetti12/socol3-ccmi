SUBROUTINE cumastrh( kproma, kbdim, klev, klevp1, klevm1, ilab, krow,  & ! eth_as_lpj
...
! eth_as_20090731- 
USE mo_socol_lnox_main,   ONLY: socol_lnox
USE mo_kind,           ONLY: dp
...
USE mo_socol_namelist, ONLY: interactivelnox
!
IMPLICIT NONE
!
INTEGER, INTENT (IN) :: kproma, kbdim, klev, klevp1, ktrac, klevm1, krow
!
...
!!$             pten,     zsfl,     zdpmel,   itopm2)
  CALL cuflx(kproma,   kbdim,    klev,     klevp1, krow,               &
             pqen,     pqsen,    ztenh,    zqenh,                      &
             ktrac,                                                    &
             zpmfun,   &                          ! eth_as_20090731
             zxtenh,   zmfuxt,   zmfdxt,                               &
             ...
             pten,     zsfl,     zdpmel,   itopm2,                     &
             pxten,    &                          ! eth_as_20090731
             xn3depcv, cvdprec,  kconbot, &       ! eth_as_scav
             pxtu,     plu)                       ! eth_as_scav
!
!-----------------------------------------------------------------------
!
...
!!$              prsfc,    pssfc,    paprc,    paprs)
  CALL cudtdq(kproma, kbdim, klev, klevp1, itopm2, ldcum, ktrac, krow, & ! eth_as_lpj
              pxten,                             & ! eth_as_20090731
              paphp1,   pten,     ptte,     pqte,                      &
              pxtte,    pxtec,    zmfuxt,   zmfdxt,                    &
              zmfus,    zmfds,    zmfuq,    zmfdq,                     &
              ...
              xn3depcv, cvdprec,  kconbot)         ! eth_as_scav 
!
!*    0.0          LIGHTNING ETH_TS
!                  --------------------------------------------------



 IF (interactivelnox) CALL socol_lnox(kproma, ztenh, klev, kbdim, klevp1,     &
