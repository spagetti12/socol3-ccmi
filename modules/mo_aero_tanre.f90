  ...
  DO jk = 1, klev
    DO jl = 1, kproma
      ...
      IF (lsocol) THEN                                                !MSSOCOL
         ! Use zaetr_socol instead of zaetr:                          !MSSOCOL
         zaetr = zaetr_socol(jl,jk)                                   !MSSOCOL
      ELSE                                                            !MSSOCOL
      ...
      IF (lsocol) THEN                                                !MSSOCOL
         ! No stratospheric Tanre aerosols:                           !MSSOCOL
         zaero(jl,jk,4) = 0._dp                                       !MSSOCOL
         zaero(jl,jk,5) = 0._dp                                       !MSSOCOL
      ELSE                                                            !MSSOCOL
