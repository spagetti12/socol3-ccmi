MODULE mo_io
  ...
  TYPE (FILE_INFO), SAVE         :: wetlnc1, nppnc1, tsnc1, ch4nc1 ! eth_as_ch4
  TYPE (FILE_INFO), SAVE         :: o3nc1
...
!==============================================================================
  SUBROUTINE IO_init
    ...
    icenc1%opened = .FALSE.
    icenc2%opened = .FALSE.
    wetlnc1%opened = .FALSE.  ! eth_as_ch4
    nppnc1%opened  = .FALSE.  ! eth_as_ch4
    tsnc1%opened   = .FALSE.  ! eth_as_ch4
    ch4nc1%opened   = .FALSE.  ! eth_as_ch4
    o3nc1%opened   = .FALSE.
    flunc1%opened = .FALSE.
    header%opened = .FALSE.
