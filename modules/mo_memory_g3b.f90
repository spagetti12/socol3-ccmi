...
CONTAINS
  ...
  SUBROUTINE construct_g3b
    ...
    CALL add (g3b,'ttropo',   ttropo   ,code=238 ,contnorest=.true.,             &
         longname='Temperature at WMO defined tropopause'          ,units='K'       )
  ...
  ,units='W/m**2'    ,contnorest=.true.)
    ...
    CALL add (g3b,'acdnc',    acdnc    ,code=136,lpost=.TRUE.,longname='cloud droplet number concentration'     ,units='1/m**3'   )
