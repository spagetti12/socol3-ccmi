MODULE mo_control
  ...
  INTEGER :: izcalc_start   !   start year of GCR/EEP/SPE calculations (needed for proper array creation)
  INTEGER :: izcalc_stop    !   stop year of GCR/EEP/SPE calculations (needed for proper array creation)
  ...
  LOGICAL :: lsocol   = .FALSE.  !   .true. for SOCOL simulation    !MSSOCOL 
  ...
  ! Wetland map and NPP climatology    ! eth_as_ch4
  INTEGER :: nwlm     = 40 !  *nwlm*      logical unit for wetland map  
  INTEGER :: nnpp     = 41 !  *nnpp*      logical unit for npp climatology
  INTEGER :: ntsurf   = 43 !  *ntsurf*    logical unit for annual mean surface temperature

  ! CMDL CH4 climatology   ! eth_as_ch4
  INTEGER :: nch4 = 44     !  *nch4*  logical unit for CMDL CH4 climatology
